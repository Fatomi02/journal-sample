        ...
        <Navbar />
            ...
            <section className="2xl:w-[64%] mx-auto md:flex justify-between w-[86%] mt-[70px] mb-10">
                <div className="w-full mx-auto md:w-[75%] text-justify text-[#626262] text-[16px] mt-[-36px] leading-7">
                    ...
                    <p className="text-[16px] leading-7 mt-4">Where an author is prevented from being the copyright holder (for instance in the case of US government employees or those of Commonwealth governments), minor variations may be required. Authors requiring a variation of this type should <a className="text-[#800000] font-medium" href="/">inform PAJOLS</a> during or immediately after submission of their article. Changes to the copyright line cannot be made after publication of an article.</p>
                </div>
                <Widget />
            </section>
        <Footer />
