    ...
    return (<>
                ...
                <section className="2xl:w-[64%] bg-[#FCFCFC] mx-auto md:flex justify-between w-[86%] mt-[70px] mb-10">
                    <div className="w-full mx-auto md:w-[75%] text-justify text-[#626262] text-[14px] mt-[-36px] leading-7">
                        <h1 className="text-[#d80c6c] font-semibold text-center mb-2">PREPARING YOUR MANUSCRIPT</h1>
                        ...
                        <div className="my-4">
                            <strong className="text-[#d80c6c] text-[14px] my-6">Title</strong>
                        ...
                        <div className="my-4">
                            <strong className="text-[#d80c6c] text-[14px] my-6">Authors and affiliations</strong>
                        ...
                        <div className="my-4">
                            <strong className="text-[#d80c6c] my-6 text-[14px]">Abstract</strong>
                        ...
                        <div className="my-4">
                            <strong className="text-[#d80c6c] text-[14px] my-6">Keywords</strong>
                        ...
                        <div className="my-4">
                            <strong className="text-[#d80c6c] text-[14px] my-6">Introduction</strong>
                        ...
                        <div className="my-4">
                            <strong className="text-[#d80c6c] text-[14px] my-6">Methodology</strong>
                        ...
                        <div className="my-4">
                            <strong className="text-[#d80c6c] text-[14px] my-6">Results</strong>
                        ...
                        <div className="my-4">
                            <strong className="text-[#d80c6c] text-[14px] my-6">Discussion</strong>
                        ...
                        <div className="my-4">
                            <strong className="text-[#d80c6c] text-[14px] my-6">Acknowledgments</strong>
                        ...
                        <div className="my-4">
                            <strong className="text-[#d80c6c] text-[14px] my-6">Declaration of conflict of interest</strong>
                        ...
                        <div className="my-4">
                            <strong className="text-[#d80c6c] text-[14px] my-6">References</strong> (Times New Roman, size 10 font)
                            ...
                            <strong className="text-[#d80c6c] text-[14px] my-1">References should be formatted as follows:</strong> <br />
                            <strong className="text-[#d80c6c] text-[14px] my-1 italic">Journal article</strong>
                            ...
                            <strong className="text-[#d80c6c] text-[14px] my-1 italic">Accepted, unpublished papers:</strong>
                            <p className="text-[14px] leading-8">Same as above, but “In press” appears instead of the page numbers.</p>

                            <strong className="text-[#d80c6c] text-[14px] my-1 italic">Book</strong>
                            ...
                            <strong className="text-[#d80c6c] text-[14px] my-1 italic">Chapter in Book:</strong>
                            ...
                            <strong className="text-[#d80c6c] text-[14px] my-1 italic">Figures & Tables</strong>
