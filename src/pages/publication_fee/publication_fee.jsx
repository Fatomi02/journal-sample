            ...
            <Navbar />
                ...
                <section className="2xl:w-[64%] mx-auto md:flex justify-between w-[86%] mt-[70px] mb-10">
                    <div className="w-full mx-auto md:w-[75%] text-justify text-[#626262] text-[16px] mt-[-36px] leading-7">
                        ...
                        <p className="text-[16px] leading-7 my-6">To cover the cost for providing our high-quality publishing service and free access to readers, authors pay a one-time article processing charge (APC) of N50,000 (Fifty thousand naira only) for national authors and $200 (Two hundred dollars) for authors outside Nigeria for manuscripts accepted after peer-review. The major factor that will determine national or international author Is the corresponding author. </p>
                        <p className="text-[16px] leading-7 mb-6">There are no charges for rejected articles, no submission charges, and no surcharges based on the length of an article, figures or supplementary data. Editorial items (Editorials, Corrections, Additions, Retractions, Letters, Comments, etc.) are published free of charge.</p>
