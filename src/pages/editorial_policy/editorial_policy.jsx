    ...
    return (
        ...
        <Navbar />
            ...
            <section className="2xl:w-[64%] bg-[#FCFCFC] mx-auto md:flex justify-between w-[86%] mt-[70px] mb-10">
                ...
                <p className="text-[14px] my-4 leading-7">Submission of a manuscript clearly indicates that all authors have granted permissions to publish it. The submitting author (corresponding author) is however responsible for ensuring that the article's publication has been approved by all coauthors.</p>
                <strong>Confidentiality</strong>
                <p className="text-[14px] my-4 leading-7">Editors and reviewers would treat all manuscripts submitted to <strong>Acta BioScientia</strong> with confidentiality </p>
                </div>
                <Widget />
            </section>
        <Footer />
