    ...
    <>
      ...
      <div className="w-full mt-[240px] md:mt-[250px] text-center relative z-0 mx-auto bg-[#f6f6f6] py-[30px] shadow-[0_1px_0px_0px_rgba(0,0,0,0.3)]">
        ...
        <ul className="flex justify-center gap-4 text-[#797979] mt-3">
          ...
          <li className="hover:underline">
            <Link to="/editorial-in-board">Editor in Board</Link>
          </li>
        </ul>
      </div>
      <section className="2xl:w-[64%] bg-[#FCFCFC] mx-auto md:flex justify-between w-[86%] mt-[70px] mb-10">
        <div className="w-full mx-auto md:w-[70%] text-justify text-[#626262] text-[14px] mt-[-36px] leading-7">
          <strong className="text-[#800000] text-center">
            Editor in chief:
          </strong>
          <p className="text-[14px] my-4 leading-7">
            Dr. Olakunle James Onaolapo MBBS (Ibadan), M.Sc.; Ph.D. (Ife),
            Reader, Department of Pharmacology and Therapeutics, LAUTECH,
            Ogbomoso
          </p>
          <strong className="text-[#800000] text-center">
          Associate Editors:
          ...
          <ul className="text-[14px] my-4 leading-7 list-decimal pl-6">
            <li>Dr Joshua Falade (MBBS, FMCPsych, Ph.D), Department of Pharmacology, University of Medical Sciences, Ondo, Ondo State </li>
            <li>Dr Abiodun Abioye Oyeleke B. Sc. M.Sc. Ph.D, Department of Anatomy, Federal University Oye-Ekiti</li>
          </ul>
          <strong className="text-[#800000] text-center">
          ...
          <p className="text-[14px] my-4 leading-7">
          Department of Pharmacology and Therapeutics, Faculty of Basic Clinical Sciences, Ladoke Akintola University of Technology, Ogbomoso <br />
          <label className="font-bold">Email:</label> <a href="mailto:ojonaolapo@lautech.edu.ng">ojonaolapo@lautech.edu.ng</a> <br />
          <label className="font-bold">Tel:</label> <a href="tel:+2349026346768">+234 9026346768</a>
          </p>
        </div>
        <Widget />
      </section>
