    ...
    return (<>
        <section className="2xl:w-[64%] w-[86%] mt-[310px] relative z-0 mx-auto md:flex justify-between mb-10">
            <div className="w-full md:w-[75%]">
                ...
                <div className="py-6">
                    <p className="text-justify text-[14px] selection:bg-[#d80c6c] selection:text-white leading-[28px] text-[#626262] mb-[10px]">
                    ...
                    <p className="text-justify text-[14px] selection:bg-[#d80c6c] selection:text-white text-[#626262]  leading-[28px] mb-[10px]">
                    ...
                    <p className="text-justify text-[14px] selection:bg-[#d80c6c] selection:text-white text-[#626262]  leading-[28px] mb-[30px]">
                    ...
                    <div className="mt-[20px] md:mt-[60px] justify-between md:flex">
                        ...
                        <div className="w-full pt-[10px] md:w-[56%]">
                            <span className="text-[20px] lg::text-[39px] selection:bg-[#d80c6c] selection:text-white font-normal mb-[22px] text-[#800000]">Aim & Scope</span>
                            <p className="text-justify flex flex-col gap-3 mt-[10px] md:mt-0 text-[14px] xl:text-[14px] selection:bg-[#d80c6c] selection:text-white text-[#626262] mb-[35px] leading-[28px]">
                ...
                <h2 className="text-[18px] md:text-[32px] text-[#d80c6c] selection:bg-[#d80c6c] selection:text-white font-bold mb-[15px]">WHY PUBLISH WITH US</h2>
                <ul className="text-[14px] md:text-[14px] list-disc flex flex-col gap-[15px] selection:bg-[#d80c6c] selection:text-white pl-[30px]">
                ...
                <div className="md:flex-row flex flex-col gap-[30px] w-[96%] md:w-full mt-[40px] mx-auto">
                    <div className="w-full md:w-[320px] mx-auto">
                        ...
                        <div className="lg:ml-[64px] mt-[20px] flex flex-col gap-[15px]">
                            <span className="text-[24px] text-[#e67817] font-medium selection:bg-[#d80c6c] selection:text-white">Open Access</span>
                            <span className="selection:bg-[#d80c6c] text-[18px] leading-7 text-[#626262] selection:text-white">The basic idea of open access is to make copyright-able works available without all</span>
                    ...
                    <div className="w-full md:w-[320px] mx-auto">
                        ...
                        <div className="lg:ml-[64px] mt-[20px] flex flex-col gap-[15px]">
                            <span className="text-[24px] text-[#00923f] font-medium selection:bg-[#d80c6c] selection:text-white">Publication Ethics</span>
                            <span className="selection:bg-[#d80c6c] text-[18px] leading-7 text-[#626262] selection:text-white">Acta BioScientia adheres to the highest standards of publishing ethics, with rigorous processes in place to ensure this is achieved</span>
                    ...
                    <div className="w-full md:w-[320px] mx-auto">
                        ...
                        <div className="lg:ml-[64px] mt-[20px] flex flex-col gap-[15px]">
                            <span className="text-[24px] text-[#007dc2] font-medium selection:bg-[#d80c6c] selection:text-white">Submission</span>
                            <span className="selection:bg-[#d80c6c] text-[18px] leading-7 text-[#626262] selection:text-white">The basic idea of open access is to make copyright-able works available without all</span>
                ...
                <span className="text-[14px] leading-6 md:text-[14px] selection:bg-[#d80c6c] selection:text-white md:leading-9">Creative Commons provides option to choose which rights one want to control and want to grant to others with respect to ones publication. They do not replace copyright, but are based upon it. The publications here are licensed under a <a className="text-[#d80c6c]" href="/">Creative Commons Attribution 4.0 International License.</a></span>
