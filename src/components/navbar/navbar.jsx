        ...
        <section className="w-full pt-1 section">
            <nav className="xl:w-[64%] mx-auto mt-3">
                <div className="flex items-center gap-[20px] pl-[30px] lg:pl-0">
                    ...
                    <div className="pl-4 xl:w-[800px] hidden md:block">
                        <h1 className="text-[28px] lg:text-[30px] xxl:text-[36px]  lg:leading-[40px] mb-3 text-primary">Acta BioScientia</h1>
                        <span className="font-medium text-primary"><i className="text-[14px] lg:text-[16px]">Journal of Biomedical and Biological Sciences</i></span>
                    </div>
                </div>
            </nav>
            <div className="nav-links-div">
                <div className="hidden w-[full] lg:flex justify-center gap-4 text-white">
                    ...
                    <div className="hover">
                        <div className="w-[90px] h-[70px] flex flex-col text-center link justify-center">About us</div>
                        <div className="bg-primary text-[14px] hidden sub_link w-[220px]">
                            <ul>
                    ...
                    <div className="hover">
                        <div className="w-[90px] h-[70px] flex flex-col text-center justify-center" href="/">Policy</div>
                        <div className="bg-primary text-[14px] hidden sub_link w-[220px]">
                            <ul>
                    ...
                    <div className="hover">
                        <div className="w-[90px] h-[70px] flex flex-col text-center justify-center" href="/">Journal</div>
                        <div className="bg-primary hidden sub_link w-[220px]">
                            <ul>
                ...
                <div className="flex items-center gap-4">
                    ...
                    <button className="py-3 px-4 bg-secondary text-white rounded-md">Search</button>
                </div>
            </div>
        </section>
